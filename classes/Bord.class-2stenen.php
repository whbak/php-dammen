        ...
        for ($rij = 0; $rij < 10; $rij++) {
            ...
            for ($kolom = 0; $kolom < 10; $kolom++) {
                if ((($rij % 2) + ($kolom % 2)) % 2 == 0) {
                    if ($rij < 4) {
                        /* beging gehakt voor 1 witte en 1 zwart steen */
                        if ($rij == 1 && $kolom == 3) { $rijVakjes[] = new Vak("wit", new Steen("wit"));
                        } else {
                            if ($rij == 0 && $kolom == 6) { $rijVakjes[] = new Vak("wit", new Steen("zwart"));
                            } else {
                            $rijVakjes[] = new Vak("wit", /*new Steen("zwart")*/);
                            }
                        }
                        /* einde gehakt voor 1 witte en 1 zwart steen */
                    } elseif ($rij > 5) {
